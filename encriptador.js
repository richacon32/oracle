function encriptar(traduccion){
    ...
    var exclamacion = document.querySelector("#exclamacion");
    if (texto != ""){
        var out = ""
        for(var i=0; i < texto.length; i++){
            if(((texto[i] < 'a') || (texto[i] > 'z')) && (texto[i] != ' ')){
                ...
                exclamacion.style.display = "inline";  // Muestra la imagen
                return;
            }
        ...
        // Cambia la imagen y ajusta el ancho
        var headerLogo = document.getElementById("headerLogo");
        headerLogo.src = "./img/aluraoracle.jpg";
